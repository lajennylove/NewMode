...
$(document).ready(function(){
	$('#send').click(function(event){
		...
		$.ajax({
				url: 'http://represent.opennorth.ca/postcodes/' + postal + '/?format=json',
				type: 'POST',
				data: {},
				...
				success: function(data){
					...
					for (i=0; i < representatives.length; i++ ) {
						...
						appendCard ( ParseData(representative, "district_name"), ParseData(representative, "photo_url"), ParseData(representative, "name"), ParseData(representative, "district_name"), ParseData(representative, "email"));	
					}
				},
